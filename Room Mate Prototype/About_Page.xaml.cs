...
namespace Room_Mate_Prototype
{
    ...
    public sealed partial class About_Page : Page
    {
        ...
        {
            // Define Email Recipient (can create for CC and BCC as well)
            EmailRecipient sendTo = new EmailRecipient()
            {
                Name = "Name of Recipient",
                Address = "west0135@algonquincollege.com"
            };

            // Create the email object
            EmailMessage mail = new EmailMessage();
            mail.Subject = "Tech Support";
            mail.Body = "Help me!!";

            // Add recipient to the mail object
            mail.To.Add(sendTo);
